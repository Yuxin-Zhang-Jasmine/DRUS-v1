function [filtered_p] = high_pass(p,Fs,F)

    %-- Function which implements a high-pass filtering with Kaiser FIR filter
    %-- Function prototype: filtered_p = high_pass(p,Fs,[upper_freq_on upper_freq_off])
