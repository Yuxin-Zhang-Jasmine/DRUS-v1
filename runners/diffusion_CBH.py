...
class Diffusion(object):
    ...
    def sample_sequence(self, model, cls_fn=None):
        ...
        # sigmacoeLst = [4.2, 4.4, 4.6, 4.8, 5] + [2.1, 2.2, 2.3, 2.4, 2.5] + [2.5, 2.7, 2.9, 3.1, 3.3] + \
        #               [2, 2.1, 2.2, 2.3, 2.4] + [1.1, 1.2, 1.3, 1.4, 1.5] + [1.5, 1.6, 1.7, 1.8, 1.9]
        # numNoise = 5
        #
        # dasLst = ['simu_reso'] * numNoise + ['simu_cont'] * numNoise + ['expe_reso'] * numNoise \
        #          + ['expe_cont'] * numNoise + ['expe_cross'] * numNoise + ['expe_long'] * numNoise

        sigmacoeLst = [4.6, 7.1, 2.2, 5.5]
        ...
        for x_orig, classes in pbar:
            ...
            y_0 = torch.from_numpy(mat73.loadmat(
                '/home/user/Documents/MATLAB/MICCAI/picmus/CBH/yd/' + dasSaveName)['CBy'])
